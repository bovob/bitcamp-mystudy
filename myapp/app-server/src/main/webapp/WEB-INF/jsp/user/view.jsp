...
<c:if test="${not empty user}">
    <form action='update' method="post" enctype="multipart/form-data">
        ...
        <a href="https://kr.object.ncloudstorage.com/bitcamp-bucket102/user/${user.photo}">
            <img src="https://rz0apkvp4931.edge.naverncp.com/GIub2Lc5DE/user/${user.photo}?type=f&w=100&h=100">
